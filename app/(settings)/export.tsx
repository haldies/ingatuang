...
export default function ExportScreen() {
  ...
  const handleExport = async () => {
    if (period === 'custom' && !customDate) {
      showAlert({
        title: 'Pilih Bulan',
        message: 'Silakan pilih bulan untuk export data',
        type: 'warning',
      });
      return;
    }
  ...
  const getSelectedPeriodLabel = () => {
    return PERIOD_OPTIONS.find(opt => opt.value === period)?.label || 'Pilih periode';
  };

  const handlePeriodSelect = (value: ExportPeriod) => {
    setPeriod(value);
        ...
        <View style={styles.content}>
          <View style={styles.card}>
            ...
            <View style={styles.section}>
              ...
              >
                <Text style={styles.dropdownText}>{getSelectedPeriodLabel()}</Text>
                <Ionicons 
                ...
                <View style={styles.dropdownMenu}>
                  {PERIOD_OPTIONS.map((option) => (
                    <TouchableOpacity
                      ...
                      onPress={() => handlePeriodSelect(option.value as ExportPeriod)}
                    >
                      <Text
                        style={[
